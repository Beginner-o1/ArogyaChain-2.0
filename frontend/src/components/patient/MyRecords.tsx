...
export default function MyRecords({
  ...
  return (
    <>
            ...
            <div key={record.id} className="pd-record-item">
              ...
              <div className="pd-record-header">
                ...
                <div className="pd-record-actions">
                  ...
                  {/* ── QR button: shows this record's ID as a QR code ── */}
                  <button
              ...
              {/* ── Share / Grant access panel ── */}
              {selectedRecord === record.id && (
                <div className="pd-share-form">
                  <p className="pd-share-label">Grant access to:</p>
                  <div className="pd-share-row">
                    ...
                    <div className="pd-share-actions">
                      ...
                      <button
                        ...
                        onClick={() => { setSelectedRecord(null); setGrantAddress(""); }}
                      >
                        Cancel
                      </button>
                    </div>
      ...
      {/* Scanner modal (for grant access input) */}
      <QRScannerModal
        isOpen={scanQrOpen}
